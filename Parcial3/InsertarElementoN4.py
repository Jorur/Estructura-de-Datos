#Pregunta 4, Jorge Urioste Hurtado
class Cola:
    #Inicia la cola 
    def __init__ (self):
        self.elementos = []
    ...
    def insertar(self, x, valor):
        self.elementos.insert(x, valor)
...
Q.agregar(4)
Q.insertar(2, 7)
print(f"La cola con el elemento X insertado es: {Q.elementos}")
...
P.apilar(5)
P.insertar(0, 8)
print(f"La pila con elemento insertado es: {P.elementos}")
...
print("La lista con el elemento insertado es: ")
